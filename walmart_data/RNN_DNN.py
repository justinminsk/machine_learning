...
rnd_search = RandomizedSearchCV(DNNClassifier(random_state=42), param_distribs, n_iter=5, n_jobs=-1,
                                random_state=42, verbose=2)
rnd_search.fit(X_train, y_train, X_valid=X_test, y_valid=y_test, n_epochs=30)
logging.info(" ")
logging.info("-----------------------")
...
logging.info(rnd_search.best_params_)
